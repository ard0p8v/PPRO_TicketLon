        ...
        <div class="col-xs-12">
            ...
            <form:form method="POST" modelAttribute="userForm" class="form-horizontal">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    ...
                    <div class="col-sm-10">
                        <form:input type="text" path="name" class="form-control" placeholder="Zadejte jméno uživatele" autofocus="true"></form:input>
                ...
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    ...
                    <div class="col-sm-10">
                        <form:input type="text" path="surname" class="form-control" placeholder="Zadejte příjmení uživatele" autofocus="true"></form:input>
                ...
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <label class="control-label col-xs-2">Role uživatele:</label>
                    <div class="col-sm-10">
